...
public class Computadora {
    ...
    public Computadora(String marca, String modelo, Monitor pantalla, Mause raton, Teclado teclado, Procesador cpu) {
        this.marca = marca;
        this.modelo = modelo;
    ...
    public Mause getRaton() {
        return raton;
    }

    public void setRaton(Mause raton) {
        this.raton = raton;
    }
